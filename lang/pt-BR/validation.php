...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Mensagens de Idioma para Validação
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'mac_address' => 'O campo :attribute deve ser um endereço de MAC válido.',
    'max' => [
    ...
    | especificar rapidamente uma linha de idioma personalizada para uma regra de atributo específica.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de idioma são usadas para substituir nossos espaços reservados de atributo
